...
/*   Updated: 2023/02/22 21:57:40 by tmarts           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static t_3d	ft_rotate_z(t_3d *s_3d, t_map *s_map)
{
	...
	// new_pt.pt_x = (s_3d->pt_x - s_map->x_max / 2) * cos(s_map->s_rot.z_angle) \
	// + (s_3d->pt_y - s_map->y_max / 2) * -sin(s_map->s_rot.z_angle);
	// new_pt.pt_y = (s_3d->pt_x - s_map->x_max / 2) * sin(s_map->s_rot.z_angle) \
	// + (s_3d->pt_y - s_map->y_max / 2) * cos(s_map->s_rot.z_angle);
